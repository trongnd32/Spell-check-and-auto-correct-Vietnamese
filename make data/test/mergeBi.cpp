...
//
////read __form2__
//void splitWstr(wstring wstr, wstring& word1, wstring &word2, int& fre) {
//	int n = wstr.length();
//	word1 = L"";
//	word2 = L"";
//	fre = 0;
...
//	wifstream fin1(L"./data new/bi1-2-3-4.txt");
//	if (!fin1) {
//		wcout << L"Không thể đọc file bi1.txt\n";
//	}
//	else { fin1.imbue(loc); }
//
//	wifstream fin2(L"./data new/bi5.txt");
//	if (!fin2) {
//		wcout << L"Không thể đọc file bi2.txt\n";
//	}
//	else { fin2.imbue(loc); }
//
//	wofstream fout(L"./data new/bi.txt");
//	fout.imbue(loc);
//
...
//			getline(fin1, wstr1);
//			getline(fin2, wstr2);
//			splitWstr(wstr1, word11, word12, fre1);
//			splitWstr(wstr2, word21, word22, fre2);
//			word1 = word11 + L' ' + word12;
//			word2 = word21 + L' ' + word22;
//		}
//
//		if (read == 1) {
//			getline(fin1, wstr1);
...
//		if (cmp == 0) {
//			#ifdef __FORM1__
//				fout << word11 << L"," << word12 << L"," << fre1 + fre2 << endl;
//			#endif // __FORM1__
//
//			#ifdef __FORM2__
...
//		else if (cmp < 0) {
//			#ifdef __FORM1__
//				fout << word11 << L"," << word12 << L"," << fre1 << endl;
//			#endif // __FORM1__
//
//			#ifdef __FORM2__
...
//		else if (cmp > 0) {
//			#ifdef __FORM1__
//				fout << word21 << L"," << word22 << L"," << fre2 << endl;
//			#endif // __FORM1__
//
//			#ifdef __FORM2__
...
//
//	#ifdef __FORM1__
//		if (fre1 != 0) fout << word11 << L"," << word12 << L"," << fre1 << endl;
//		if (fre2 != 0) fout << word21 << L"," << word22 << L"," << fre2 << endl;
//	#endif // __FORM1__
//
//	#ifdef __FORM2__

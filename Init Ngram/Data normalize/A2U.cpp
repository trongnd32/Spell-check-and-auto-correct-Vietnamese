...
wstring A2UGi(string inputFirstConsonant, string inputVowel, string inputLastConsonant) {
	...
	if (inputVowel.length() == 0) {
		wstring rt = L"gi";
		if (inputTone.compare("s") == 0) rt = (L"gí" + s2ws(inputLastConsonant));
		if (inputTone.compare("f") == 0) rt = (L"gì" + s2ws(inputLastConsonant));
		if (inputTone.compare("r") == 0) rt = (L"gỉ" + s2ws(inputLastConsonant));
		if (inputTone.compare("x") == 0) rt = (L"gĩ" + s2ws(inputLastConsonant));
		if (inputTone.compare("j") == 0) rt = (L"gị" + s2ws(inputLastConsonant));
		return rt;
	}
	else {
